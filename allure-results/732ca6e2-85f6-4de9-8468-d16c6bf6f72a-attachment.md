...
```
Error: locator.fill: selector: expected string, got undefined
```

```
Error: expect(locator).toBeVisible() failed

Locator:  getByAltText('Swag Labs')
Expected: visible
Received: undefined

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByAltText('Swag Labs')
...
```ts
  ...
  12 | 
> 13 |     await expect(page.getByAltText('Swag Labs')).toBeVisible();
     |                                                  ^ Error: expect(locator).toBeVisible() failed
