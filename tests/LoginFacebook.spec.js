...
// test ("login for facebook", async({page})=>{
//     await page.goto("https://www.facebook.com/")

//     await page.locator("#_R_1h6kqsqppb6amH1_").fill("example@gmail.com")
//    // await page.locator("#_R_1hmkqsqppb6amH1_").fill("Sandy5212$")
//     await page.locator('[type="password"]').fill("Sandy5212$")
...
//    // await page.locator("#_R_1hmkqsqppb6amH1_").fill("Sandy5212$")
//     await page.locator('//input[@type="password"]').fill("Sandy5212$")
